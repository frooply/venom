...
app.get("/contatosGrupo", async function(req, res, next) {
  var result = await Sessions.getContatosGrupo(
    req.query.sessionName,
    req.query.grupoid
  );
  res.json(result);
...
app.post("/postLinkGrupo", async function sendLink(req, res, next) {
  console.log(req.body);
  var result = await Sessions.sendLinkPreview(
    req.body.sessionName,
    req.body.number,
